resource "local_file" "inventory" {
    ...
    machine4 ansible_host=${aws_instance.machine-4.public_ip}  ansible_ssh_private_key_file=/home/ubuntu/jenkins/workspace/'demo pipeline'/infrastructure/keys-machine-4 ansible_ssh_user=ubuntu
    EOF
}